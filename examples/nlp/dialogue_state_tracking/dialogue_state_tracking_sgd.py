...
def create_pipeline(dataset_split='train'):
    ...
    if dataset_split == 'train':
        loss = dst_loss(
            ...
            logit_cat_slot_start=logit_cat_slot_start,
            logit_cat_slot_end=logit_cat_slot_end,
            ...
            categorical_slot_value_start=data.categorical_slot_value_start,
            categorical_slot_value_end=data.categorical_slot_value_end,
