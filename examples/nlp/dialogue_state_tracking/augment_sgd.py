...
def parse_args():
    ...
    parser.add_argument("--concat_orig_dialogue", action="store_true", help="contenate original dialogue to the augmented one")
    parser.add_argument("--input_dir", type=str, help="data directory. contains one schema.json and multiple dialogue*.json files")
    ...
    parser.add_argument("--replace_word_prob", type=float, default=1.0, help="likelihood to modify a word in an utterance")
