...
from tools.text_denormalization.normalize import normalizers
from tools.text_denormalization.utils import (
    evaluate,
    known_types,
    load_files,
...
if __name__ == "__main__":
    ...
    if args.category is None:
        ...
        sentences_accuracy = evaluate(preds=sentences_prediction, input=sentences_normalized, labels=sentences_un_normalized)
    ...
    for token_type in tokens_per_type:
        ...
        print("  - Normalized. Evaluating...")
        token_accuracy[token_type] = evaluate(preds=tokens_prediction, input=tokens_normalized, labels=tokens_un_normalized)
